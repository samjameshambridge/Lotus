...
const uiCtrl = {
    ...
    modalAppDisplay: function (state) {
    ...
    modalHandler: function () {
        const modalGithub = document.querySelector("#github-btn"),
            ...
            modalReturn = document.querySelector("#return-btn");

        this.modalAppDisplay('open')

        modalCross.addEventListener('click', () => {
            uiCtrl.modalAppDisplay()
        })
    ...
    navMover: function (mouseOver) {
        ...
        if (!mouseOver) {
            ...
            window.innerWidth < 768 ? navContainer.style.transform = "translateX(-33vw)" : navContainer.style.transform = "translateX(-20vw)";
